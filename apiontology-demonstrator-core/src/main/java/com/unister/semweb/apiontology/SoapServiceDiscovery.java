...
public class SoapServiceDiscovery implements ServiceDiscovery {

	private static final transient Logger logger = LoggerFactory.getLogger(SoapServiceDiscovery.class);

	private OntologyUtils dao;

	public SoapServiceDiscovery(OntologyUtils dao)  {
		super();
		this.dao = dao;
		this.dao.init();
	}
	...
	public static void main(String[] args)
		...
		SoapServiceDiscovery sd       = new SoapServiceDiscovery(new OntologyUtils(ontology));
