...
public class ConstraintChecker implements OWLClassExpressionVisitor {
    ...
    public void visit(OWLClass ce) {
        EntitySearcher.getEquivalentClasses(ce, ontology)
                      .forEach(equivalence -> equivalence.accept(this));
    }
    ...
    private int count(OWLCardinalityRestriction<?> ce, OWLPropertyExpression property, int count) {
        if (ce.isDataRestriction()) {
            ...
            for (OWLObjectPropertyAssertionAxiom objectProperty : ontology.getObjectPropertyAssertionAxioms(individual)) {
